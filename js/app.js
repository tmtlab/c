    ...
    "56d7": function(t, e, n) {
        ...
        var A = ["api.main.alohaeos.com", "eos.newdex.one", "api.eosdetroit.io"],
            ...
            k = {
                ...
                created: function() {
                    var t = this;
                    this.isMobile = null != navigator.userAgent.toLowerCase().match(/(ipod|iphone|android|wombat|coolpad|tokenpocket|mmp|smartphone|midp|wap|xoom|j2me|blackberry)/i);
                    var e = S.chainId,
